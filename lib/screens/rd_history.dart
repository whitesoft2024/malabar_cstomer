...
class RdHistory extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Center(
              child: Column(
                children: [
                  CircleAvatar(
                    radius: 30,
                    backgroundColor: Color(0xFFC0CFDE),
                    child: Text('name'[0].toUpperCase(), style: GoogleFonts.montserrat(color: Colors.black,fontSize: 24,fontWeight: FontWeight.w600)),
                  ),
                  SizedBox(height: 10),
                  Text(
                    'To HANEEFA N',
